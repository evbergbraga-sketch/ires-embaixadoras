  ...
  if (!document.getElementById('cap-styles')) {
    ...
    style.textContent = `
      ...
      @media (min-width: 768px) {
        ...
        .cap-dots { display:none; }
        .cap-player-wrap { position:relative;flex-direction:row;align-items:flex-start;max-width:1600px;margin:0 auto; }
        .cap-player-left { flex:1;min-width:0;max-width:980px; }
        .cap-player-right { width:360px;flex-shrink:0;border-left:.5px solid #E8D9C5;background:#fff;max-height:600px;overflow-y:auto; }
      }
    `;
